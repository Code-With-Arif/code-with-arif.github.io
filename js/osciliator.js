function initOciliator(remove) {
    ...
    if(!remove) {
        ...
        var color = randomIntFromInterval(1, 4);
        ...
        function loop() {
            ...
            // } else if (color == 3) {
            //     ctx.strokeStyle = 'hsla(147,98%,56%,0.25)';
            // } else if (color == 4) {
            //     ctx.strokeStyle = 'hsla(233,98%,56%,0.25)';
            // }
            if (isGoingUp) {
                colorLoop += .1;
                if (colorLoop >= 255) {
            ...
            ctx.strokeStyle = `hsla(${colorLoop},98%,56%,0.25)`;
        ...
        ctx = document.getElementById('osciliatorCanvas').getContext('2d');
